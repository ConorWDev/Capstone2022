 ...
 */
package Controller.AnnouncementServices;
...
public class announcementController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String announcementId = request.getParameter("cohortId");
        
        
        ArrayList<Announcement> announcements = dbOps.getCohortAnnouncements(announcementId);
