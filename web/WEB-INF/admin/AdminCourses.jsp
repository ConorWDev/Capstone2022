                        ...
                        <div class="row mb-3">
                            <div class="col pe-4 ">
                                <form action="SiteNavigationAdmin?nav=courses&op=2" method="POST">
                                    ...
                                    <div class="row ps-2">
                                        <select multiple="multiple" class="form-select border border-secondary" id="select1" name="courseIDs"  onchange="this.form.submit()">
                            ...
                            <div class="col">
                                ...
                                <div class="scrollbox border rounded border-secondary " style="overflow-x:scroll;height:450px;background-color: white">
